package com.meigsmart.meiglibs.http.download;

import com.meigsmart.meiglibs.http.download.listener.DownloadListener;
import com.meigsmart.meiglibs.http.download.util.FileUtils;
