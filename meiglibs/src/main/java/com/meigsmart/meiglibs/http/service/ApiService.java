package com.meigsmart.meiglibs.http.service;

import com.meigsmart.meiglibs.model.BindDeviceModel;
import com.meigsmart.meiglibs.model.ClientsModel;
import com.meigsmart.meiglibs.model.ClientsUpdateModel;
import com.meigsmart.meiglibs.model.CreateGroupModel;
import com.meigsmart.meiglibs.model.DeviceDeleteModel;
import com.meigsmart.meiglibs.model.DeviceEventsListModel;
import com.meigsmart.meiglibs.model.DeviceInfoModel;
import com.meigsmart.meiglibs.model.DeviceListModel;
import com.meigsmart.meiglibs.model.DeviceTrackListModel;
import com.meigsmart.meiglibs.model.GroupDelModel;
import com.meigsmart.meiglibs.model.GroupListDataModel;
import com.meigsmart.meiglibs.model.GroupListModel;
import com.meigsmart.meiglibs.model.GroupMembersTrackModel;
import com.meigsmart.meiglibs.model.GroupUpdateModel;
import com.meigsmart.meiglibs.model.MemberAddModel;
import com.meigsmart.meiglibs.model.MemberDelModel;
import com.meigsmart.meiglibs.model.SendCompletedModel;
import com.meigsmart.meiglibs.model.UpLoadLocationModel;
import com.meigsmart.meiglibs.model.UpdateModel;
import com.meigsmart.meiglibs.model.VoiceMessageListModel;
import com.meigsmart.meiglibs.model.VoiceMsgDataModel;
...
public interface ApiService {
    ...
    Observable<ClientsModel> register(@Body RequestBody requestBody);//设备激活

    @POST("clients.json")
    Observable<ClientsModel> registerApp(@Body RequestBody requestBody);//app激活
    ...
    Observable<DeviceTrackListModel> getDeviceTrackList(@Path("device_uuid") String device_uuid);//7.2.获取设备轨迹

    @POST("device/{device_uuid}/events.json")
    Observable<DeviceEventsListModel> getDeviceEventList(@Path("device_uuid") String device_uuid, @Query("page") String page);//7.2.获取设备轨迹
